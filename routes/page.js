...
router.get(
  "/tambah-emergency-page",
  isAuth,
  pageControllers.tambahEmergencyPage
)
...
// Detail Pasien
router.get(
  "/covid-pasien-detail-page/:id",
  isAuth,
  pageControllers.pasienCovidDetailPage
)

// Edit
router.get(
  "/edit-pasien-covid-page/:id",
  isAuth,
  pageControllers.editPasienCOVID
)
router.get("/edit-user-page", isAuth, pageControllers.editUser)
